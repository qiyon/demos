...
<head>
    <meta charset="UTF-8">
    <title>管理登陆</title>
    <link type="text/css" href="<?php echo Yii::app()->request->baseUrl;?>/js/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <div class="row">
                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="remember" value="1" > 保持登陆 <span class="label label-info">一周</span>
                                </label>
                            </div>
                        </div>
                    </div>
